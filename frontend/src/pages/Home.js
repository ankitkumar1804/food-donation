...
import logo1 from "../asset/WhatsApp Image 2024-04-18 at 23.35.29_73d36e03.jpg";
      ...
      <div className=" w-full flex items-center  flex-col     bg-[#F5F5F5]   ">
       ...
       <div class="showcase-area">
          <div class="container">
            ...
            <span class="text-5xl " style={{color: "#3AAFB9"}}>Hello Donors!</span>  
              ...
              <p>Developed By:- </p>
              <ol>
                <li><b>1.Vishal Arunagiri</b></li>
                <li><b>2.Ankit Chaudhary</b></li>
                <li><b>3.Aryan Shukla</b></li>
              </ol>

            </div>

            <div class="right">
              <img src={logo1} alt="Person Image" class="person" />
            </div>
          </div>
        </div>
        ...
        <div className="mt-10 mb-20 w-full  flex flex-col gap-8">
          ...
          font-bold"
            ...
            behavior="alternate"
          >
              "Food is a basic human right. Let's ensure everyone has access. Donate now." - Michelle Obama &nbsp;
          ...
          <div className="container">
            <div className=" md:flex md:justify-between ">
              <div className="mb-6 md:mb-0 ">
                <img src={logo} className="mr-3 h-36" alt="FlowBite Logo" />
